...
if len(sous_representees) == 0:
    ...
    print(f"    Catégories avec moins de {seuil_min} exemples :")
...
with open(rapport_path, "w", encoding="utf-8") as f:
    ...
    if valeurs_manquantes.sum() == 0:
        ...
        f.write(" Valeurs manquantes détectées :\n\n")
    ...
    if doublons == 0:
        ...
        f.write(f" {doublons} doublons détectés.\n\n")
    ...
    if len(sous_representees) == 0:
        ...
        f.write(" Catégories sous-représentées :\n\n")
    ...
    if (valeurs_manquantes.sum() == 0 and doublons == 0 and len(sous_representees) == 0):
        ...
        f.write(" Le dataset présente des anomalies. Une correction est recommandée avant la suite.\n")
...
if (valeurs_manquantes.sum() == 0 and doublons == 0 and len(sous_representees) == 0):
    ...
    print(" QUALITÉ : DES ANOMALIES DÉTECTÉES - Vérifiez le rapport.")
